...
namespace UnityVector3Refactor
{
    class V3F3UtilsToUnityMathematicsRewriter
    {
        static async Task Main(string[] args)
        {
            ...
            dotnet run --project MigrateToUnityMathematicsP2.csproj -- "C:\Users\rowan\Workspace\Unity\Vector3ToFloat3MigrationTestingUnity\Assembly-CSharp.csproj"
            */
    ...
    class V3F3UtilsToUnityMathematicsTransformer : CSharpSyntaxRewriter
    {
        ...
        public override SyntaxNode VisitMemberAccessExpression(MemberAccessExpressionSyntax node)
        {
                ...
                propSymbol.ContainingType.ToDisplayString() == "Vector3ToFloat3Utils")
            {
                ...
                if (name == "forward") replacement = ReplaceProperties(newNode, 0, 0, 1);
                else if (name == "back") replacement = ReplaceProperties(newNode, 0, 0, -1);
                else if (name == "up") replacement = ReplaceProperties(newNode, 0, 1, 0);
                else if (name == "down") replacement = ReplaceProperties(newNode, 0, -1, 0);
                else if (name == "right") replacement = ReplaceProperties(newNode, 1, 0, 0);
                else if (name == "left") replacement = ReplaceProperties(newNode, -1, 0, 0);
                else if (name == "one") replacement = ReplaceProperties(newNode, 1, 1, 1);
                else if (name == "zero") replacement = ReplaceProperties(newNode, 0, 0, 0);
        ...
        private ExpressionSyntax ReplaceProperties(MemberAccessExpressionSyntax originalNode, float x, float y, float z)
        {
